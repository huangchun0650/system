...
<head>
    ...
    <title>訂單通知</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
    ...
    <style>
        ...
        .heading-section .subheading-black {
            margin-bottom: 20px !important;
            display: inline-block;
            font-size: 13px;
            text-transform: uppercase;
        ...
        .heading-section .subheading-black::after {
            position: absolute;
            left: 0;
            right: 0;
            bottom: -10px;
        ...
        .installments-card table th,
        .installments-card table td {
            padding: 10px;
            text-align: center;
        }
        ...
        .installments-card table tr:nth-child(even) {
            background-color: #fffefe;
            color: #000000;
        }

        .installments-card table tr:nth-child(odd) {
            background-color: #5a5b5dd7; /* 设置奇数行的背景颜色 */
            color: #f5f4f4;
        }

        .installments-card table th,
        .installments-card table td {
            order: 3px solid rgb(174, 139, 49); /* 设置表格边框颜色 */
        }
        ...
        .consignees-notes-card {
            padding: 20px 25px;
            margin: 30px;
            color: #ffffff;
            font-size: 20px;
            text-align: left;
            background-color: #e2e5e8d1;
            border-radius: 10px;
        }
                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td class="bg_light email-section" style="text-align: center;">
                                    <div class="heading-section">
                                        <span class="subheading-black">收件資訊</span>
                                        <div class="consignees-card">
                                            <div class="heading-section">
                                                <h2>{{ $consigneeName }}</h2>
                                                <h3>寄送狀態： {{ $consigneeStatus }}</h3>
                                                @unless ($consigneeTaxId == '')
                                                    <h3>
                                                        公司/統編：
                                                        <span class="text-blue">{{ $consigneeCompanyTitle }}
                                                        / <span class="text-blue">{{ $consigneeTaxId }}</span>
                                                    </h3>
                                                @endunless
                                                @unless ($consigneePostalCode == '')
                                                    <h3>郵遞區號： {{ $consigneePostalCode }}</h3>
                                                    <h3>
                                                        地址：
                                                        <span class="text-blue">
                                                            {{ $consigneeCityRegion }} {{ $consigneeAddress }}
                                                        </span>
                                                    </h3>
                                                @endunless
                                                <h3>收貨人電話： {{ $consigneeMobile }}</h3>
                                                <div class="consignees-notes-card">
                                                    <h4>{{ $consigneeNotes }}</h4>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <td class="bg_white">
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td class="bg_dark email-section" style="padding: 0 3em; text-align:center;">
                                    <div class="heading-section">
                                        <span class="subheading">繳款資訊</span>
                                        <div class="installments-card">
                                            <table cellpadding="0" cellspacing="0" border="1" width="100%">
                                                ...
                                                <tr>
                                                    <td>{{ $firstInstallments->installment_number }}</td>
                                                    <td>{{ $firstInstallments->status }}</td>
                                                    <td>{{ $firstInstallments->due_date }}</td>
                                                </tr>
                                            </table>
                                        </div>
                                        <p style="padding: 50px"><a href="{{ $orderLink }}" class="btn btn-primary">檢視我的繳款單</a></p>
                                    </div>
                                </td>
                            </tr><!-- end: tr -->
                        </table>
